...
*/
 ...
 oclick(event) {
    event.preventDefault();
    this.select_id = Number(event.target.getAttribute('pid'));
...
//    this.select_id=id;
    console.log("this.select_id = "+this.select_id+" "+typeof(this.select_id) );
...
<!-- -->
    <div class="EEEEEEEEEEEEEEEEEEEEEframe-group">${repeat(
